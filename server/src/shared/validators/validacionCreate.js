...
import Funcionario from "../../modules/funcionarios/funcionarios.model.js";

export function validarUsuario(requerido = true, actualizar = false) {
  return [];
}

export function validarFuncionario(requerido = true, actualizar = false) {
  return [
...
export function validarDetalle(requerido = true, actualizar = false) {
  return [
...
export function validarContenido(requerido = true, actualizar = false) {
  return [
    validarCampo("titulo", {
      requerido,
      longitudMaxima: 50,
    ...
    validarCampo("restricciones.cierre_administrativo", {
      requerido: false,
      tipoNumero: true,
      minNumero: 0,
    }),
...
export function validarSolicitud(requerido = true, actualizar = false) {
  return [
    validarCampo("dias", {
      requerido,
    }),
...
export function validarBandeja(requerido = true, actualizar = false) {
  return [];
}

export function validarUnidad(requerido = true, actualizar = false) {
  return [];
}

export function validarDependencia(requerido = true, actualizar = false) {
  return [];
}

export function validarSettings(requerido = true, actualizar = false) {
  return [];
}
